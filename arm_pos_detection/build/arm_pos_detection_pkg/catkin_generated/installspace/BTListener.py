...
class SubscribeAndPublish:
    ...
    def callbackKeyBoard(self, data):
        ...
        if data.data == 65:
            ...
            print("Time of Calibration: ", ros.Time())
    ...
    def callback(self, data):
        ...
        characterWinkel1 = np.arccos(-upperArmUnitVectorGlobal[3]) * 180 / np.pi
        ...
        characterWinkel2 = np.arccos(lowerArmUnitVectorGlobal[1] * upperArmUnitVectorGlobal[1] + lowerArmUnitVectorGlobal[2] * upperArmUnitVectorGlobal[2] + lowerArmUnitVectorGlobal[3] * upperArmUnitVectorGlobal[3]) * 180 / np.pi
